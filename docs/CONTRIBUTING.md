...
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/EGS-LL.git`
3. Add upstream remote: `git remote add upstream https://github.com/XAOSTECH/EGS-LL.git`
...
Feel free to open a [Discussion](https://github.com/XAOSTECH/EGS-LL/discussions) for questions or ideas.
